...
let answers = [
  ...
  "The outcome will surprise you in a good way",
  ...
  "This choice will bring positive change",
  "It will help you grow and evolve",
  "Go with the flow and trust the process",
  "You have all the information you need",
  "A different path will lead to success",
  "Try a new approach and see great results",
  "Have confidence in your abilities",
  "This decision will bring opportunities",
  "Taking risks will lead to rewards",
  "Now is the perfect moment to act",
  "Things will fall into place perfectly",
  "Stick to your original plan, it will work",
  "The plan will bring success",
  "Seek advice from trusted allies",
  "Your goals are within reach",
  "Think creatively and solutions will appear",
  "Never give up hope, success is near",
  "Take bold action and see immediate results",
  "The future is bright and full of promise",
  "You already know the right answer, trust it",
  "Small compromises will lead to big rewards",
  "Pay attention to the details, they hold the key",
  "You will find balance and harmony",
  "The future is full of exciting possibilities",
  "Start with small steps, and you’ll succeed",
  "Your efforts will be rewarded",
  "Patience and persistence will bring great results",
  "Your strategy is solid, keep going",
  "An opportunity is just around the corner",
  "Your decision will bring positive outcomes",
  "This path leads to growth and happiness",
  "Collaboration will bring great rewards",
  "You are on the right track, keep moving forward",
  "Your intuition is guiding you correctly"
];
